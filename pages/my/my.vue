<template>
	<view>
		...
		<view class="p-3 flex align-center">
			<image src="../../static/demo/6.jpg" style="height: 120rpx; width:120rpx ;
		...
		<view class="p-3 flex align-center">
			...
			" class="bg-light rounded-circle flex-shrink"></image>
			<view class=" flex flex-column pl-3 flex-1">
			sm	<text class="font-md text-dark">男 武汉</text> 
	...
	<f-list-item icon="iconshipin" title="我的作品" :showRightIcon="false" rightText="26个"
	@click="navigateTo('user-video')"></f-list-item>
		<f-list-item icon="iconshoucang1" title="收藏"@click="navigateTo('user-fava')" ></f-list-item>
			<f-list-item icon="iconguanzhu" title="关注"  rightText="365"></f-list-item>
				<f-list-item icon="iconlishi" title="我的记录" ></f-list-item>
...
<script>
	import fListItem from "@/component/common/f-list-item.vue";
 import mainBigButton from "../../component/common/main-big-button.vue";
 import fPopup from '../../component/common/f-popup.vue';
	export default {
		components:{
		   fListItem,
		   mainBigButton,
